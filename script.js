...
// -----------------------------------------------------
// --- LOGICA DE RECUPERACIÓN DE CLAVE ACTUALIZADA ---
// -----------------------------------------------------
...
function validateCode() {
    ...
    if(input == generatedRecoveryCode) {
        ...
        // Aquí simularíamos el cambio de clave o login directo
        setTimeout(() => {
            switchAuth('login');
            showStatusMsg("Ingresa con tu nueva contraseña.", "success");
