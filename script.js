...
const EMAIL_SERVICE_ID = 'service_PON_TU_ID'; 
const EMAIL_TEMPLATE_ID = 'template_PON_TU_ID';
const EMAIL_PUBLIC_KEY = 'PON_TU_KEY';
...
function recoverPassword() {
    ...
    if(email && email.includes('@')) {
        showStatusMsg(`Correo de recuperación enviado a ${email}`, "success");
    } else {
